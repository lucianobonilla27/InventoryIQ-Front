      ...
      <Row className='p-2'>
        <Col xs={12} md={4} className='mb-3'>
          <Card className='card-sucursales'>
            <Card.Img variant="top" src="./src/img/Sucursal 1.jpg" className="img-fluid" />
            <Card.Body>
        ...
        <Col xs={12} md={4} className='mb-3'>
          <Card className='card-sucursales'>
            <Card.Img variant="top" src="./src/img/Sucursal 2.jpg" className="img-fluid" />
            <Card.Body>
        ...
        <Col xs={12} md={4} className='mb-3'>
          <Card className='card-sucursales'>
            <Card.Img variant="top" src="./src/img/Sucursal 3.jpg" className="img-fluid" />
            <Card.Body>
