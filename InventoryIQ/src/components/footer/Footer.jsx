            ...
            <Card style={{ width: "20rem", height: "10rem" }} id="cardFooter2">
              <Card.Body>
                ...
                <div className="container-icon-footer d-flex justify-content-between m-1 p-0">
                  <img
                    src="../public/square-facebook.svg"
                    className="icon-footer"
                    alt=""
                  />
                  <img
                    src="../public/square-instagram.svg"
                    className="icon-footer"
                    alt=""
                  />
                  <img
                    src="../public/square-x-twitter.svg"
                    className="icon-footer"
                    alt=""
                  />
                  <img
                    src="../public/square-whatsapp.svg"
                    className="icon-footer"
                    alt=""
                  />
                </div>
                <div className="container-icon-footer d-flex justify-content-between m-1 p-0">
                  <img
                    src="../public/facebook-messenger.svg"
                    className="icon-footer"
                    alt=""
                  />
                  <img
