...
const Contacto = () => {
  return (
   ...
   <Col><div className ="text-uppercase fluid text text-center m-3"><h3>Canales de contacto</h3></div>
    ...
    <Card.Body className= 'p-1 m-1'>
      ...
      <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer"><img src="../src/img/square-facebook.svg" className="icon" alt="Facebook" /></a>
      ...
      <a href="https://www.whatsapp.com/?lang=es_LA" target="_blank" rel="noopener noreferrer"><img src="../src/img/square-whatsapp.svg" className="icon" alt="WhatsApp" /></a>
          </div>
        </Card.Body>
  </Card>
    ...
    <Card style={{ width: '46%' }} className='p-1 m-2 fluid'>
      <Card.Img variant="top" src="./src/img/celular.jpg" />
      <Card.Body>
        <DatosContacto/>
      </Card.Body>
    </Card>
...
{/*COLUMNA 2 */}
    ...
    <Col>
    <div className ="text-uppercase  fluid text text-center m-3 "><h3>Envíanos tu consulta</h3>
    </div>
    <FormContacto/>
    </Col>
